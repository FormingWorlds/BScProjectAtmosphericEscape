...
plt.plot(T_list, fluxes_imp, label='improved limiting flux', c="#D55E00")
plt.plot(temperatures, fluxes_class, label='classical limiting flux', c="#0072B2")
plt.plot(temperatures, fluxes_class_grad0, label='classical limiting flux ignoring dT/dxi', c="#CC79A7")
plt.plot(temperatures, fluxes_yelle, label='profile-independent classical limiting flux', c="#332288")
#plt.yscale('log')
