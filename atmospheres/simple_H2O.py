...
#A properties of a simple isothermal, single species (H_2O) atmosphere

#Quantity    Value                          Unit         Description
T_wind       = 10**4                        #[K]         temperature of the escaping atmosphere
mu_wind      = 3                          #[dimless]   total mean molecular weight of the escaping atmosphere assumed to be entirely ionised
mu_plus_wind = 6                          #[dimless]   mean molecular weight of the ions in the escaping atmosphere assumed to be entirely ionised
...
nu_0         = 4.835981008048 * 10**15       #[Hz]        frequency of Lyman-alpha radiation, which is the ionising radiation for HI
