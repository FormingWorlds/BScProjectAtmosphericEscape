...
M_imp_tot_per_rad.py gives a function to recreate figure 14 by Schlichting et al., showing how much impactor mass is needed for different impactor radii to eject the full atmosphere. The results for the model atmospheres are given in <b>Plot_code/fig14_models.py</b>.
